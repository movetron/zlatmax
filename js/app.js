(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".thumbs-images")) {
            const thumbsSwipernew = new swiper_core_Swiper(".thumbs-images", {
    ...
    if (document.querySelector(".filter-catalog__title")) document.querySelector(".filter-catalog__title").addEventListener("click", (function(e) {
        if (window.innerWidth < 992) document.querySelector(".filter-catalog__itmes").classList.toggle("_active");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
